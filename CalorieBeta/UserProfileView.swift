...
import FirebaseAuth
    ...
    struct UserProfileView: View {
        ...
        let primaryGreen = Color(red: 253/255, green: 251/255, blue: 237/255)

        let darkGreen =  Color(red: 0/255, green: 61/255, blue: 58/255)

        let backgroundGreen = Color(red: 0/255, green: 61/255, blue: 58/255)
        ...
        //    let backgroundGreen = Color(red: 12/255, green: 22/255, blue: 24/255)
        ...
        var body: some View {
                    ...
                    ScrollView {
                        ...
                        .background(VStack(spacing: .zero) { darkGreen }.ignoresSafeArea())
                    ...
                    .tint(backgroundGreen) // This will affect the navigation items including the back button in this view.
        ...
        func profileHeader() -> some View {
            ...
            VStack(spacing: 8) { // Vertical stack with spacing between elements.
                ...
                Image(systemName: "person.crop.circle") // Placeholder for profile image.
                    ...
                    .foregroundColor(backgroundGreen) // Gray color for the placeholder.
                ...
                Text("@MFP") // Placeholder username (replace with dynamic data).
                    ...
                    .foregroundColor(backgroundGreen) // Gray color for secondary text.
        ...
        func dailyStats() -> some View {
            ...
            VStack(spacing: 8) { // Reduced spacing between elements within the VStack

                HStack(spacing: 12) { // Horizontal stack with reduced spacing between the elements.
                    ...
                    VStack(alignment: .leading) {
                        ...
                        statBox(title: calorieGoalText(), subtitle: "Calorie Goal") // Calorie goal stat.
                            ...
                            .padding(.vertical, 4) // Reduced vertical padding around statBox

                    }

                    .padding(.horizontal, 30) // Increased horizontal padding for more space on the sides
                ...
                //            Divider() // A final separator with reduced space from above content

            }

            .padding(.top, 12) // Optional: to fine-tune top padding for the entire VStack

            .padding(.bottom, 12) // Optional: to fine-tune bottom padding for the entire VStack
            ...
            VStack(alignment: .leading, spacing: 8) { // Vertical stack aligned to the leading edge.
                ...
                if posts.isEmpty { // Handles empty state.
                    ...
                    Text("You haven’t posted anything yet.") // Placeholder text.
                        ...
                        .foregroundColor(.white) // Gray color for secondary text.
        ...
        func postView(_ post: Post) -> some View {
            ...
            .background(primaryGreen) // Light gray background for contrast.
...
//                    .frame(width: UIScreen.main.bounds.width * 0.7)
                ...
                if dailyHistory.isEmpty { // Handles empty state.
                    ...
                    ForEach(groupedDailyHistory(), id: \.date) { groupedLog in // Loops through grouped logs.
                        ...
                        .frame(maxWidth: .infinity, alignment: .center) // Ensures it respects parent width
